...
*/
public class POSTFSTSS extends POSTSTSS {

	private HashMap<String, Double> termFrequencies;
	private double[][] termFrequencyMatrix;
	
	public POSTFSTSS(String[] sent1, String[] sent2, String[] tags1, String[] tags2, double initialScore, Word2VecModel model, HashMap<String, Double> termFrequencies) {
		super(sent1, sent2, tags1, tags2, initialScore, model);
