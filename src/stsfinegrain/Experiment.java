...
public class Experiment {
    ...
    private static void printInstructions() {
    	...
    	System.out.println("The argument #6 specifies the path to the score file of the STS corpus to be used. Each line of the file should contain the fine-grained score of the corresponding line pair in the file specified by argument #4. The score file can also contain other information, but the score has to be the first item in a row, separated from other data with a tab.");
